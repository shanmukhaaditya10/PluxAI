...
const IsEmployeeAvailable = () => {
  ...
  const {isTablet, checkEmpId, isModalVisible, setisModalVisible, alertData} =
    useAppContext();
  ...
  return (
    <ScrollView
      ...
      <View
        className="px-8 items-start pt-3 space-y-2"
        style={
          isTablet()
            ? {
                width: '45%',
        ...
        <View
          className="w-full flex-row justify-end pt-3"
          style={{columnGap: 10}}>
          <CustomButton
            width={75}
            height={40}
